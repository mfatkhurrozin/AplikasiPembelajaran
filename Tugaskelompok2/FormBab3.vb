...
Public Class FormBab3
    ...
    Private Sub Next9_Click(sender As Object, e As EventArgs) Handles Next9.Click
        ...
        Back9.Visible = True
    End Sub
    Private Sub Next10_Click(sender As Object, e As EventArgs) Handles Next10.Click
        Call Reset()
        btn_Keluar.Visible = True
    ...
    Private Sub Back9_Click(sender As Object, e As EventArgs) Handles Back9.Click
        ...
        Back8.Visible = True
    End Sub
    Private Sub Back10_Click(sender As Object, e As EventArgs) Handles Back10.Click
        Call Reset()
        btn_Keluar.Visible = True
        Label10.Visible = True
        PictureBox10.Visible = True
